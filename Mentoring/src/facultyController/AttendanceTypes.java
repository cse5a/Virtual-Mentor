...
/**
 * Servlet implementation class AttendanceTypes
 */
@WebServlet("/AttendanceTypes")
public class AttendanceTypes extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("USERAUTH") != null) {
			...
			RequestDispatcher rsd = request.getRequestDispatcher("facultyPanel/AttendanceTypes.jsp");

...
/**
 * Servlet implementation class SecondInternalMark
 */
@WebServlet("/SecondInternalMark")
public class SecondInternalMark extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("USERAUTH") != null) {
			...
			Status = FacultyDao.secondInternalMarkAssign(DatabaseIds, StudentMarks);
			if(Status == true)

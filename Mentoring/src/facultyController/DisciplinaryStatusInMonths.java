...
/**
 * Servlet implementation class DisciplinaryStatusInMonths
 */
@WebServlet("/DisciplinaryStatusInMonths")
public class DisciplinaryStatusInMonths extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("USERAUTH") != null) {
			...
			RequestDispatcher rsd = request.getRequestDispatcher("facultyPanel/DisciplinaryStatusInMonths.jsp");

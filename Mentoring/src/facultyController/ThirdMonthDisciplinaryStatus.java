...
/**
 * Servlet implementation class ThirdMonthDisciplinaryStatus
 */
@WebServlet("/ThirdMonthDisciplinaryStatus")
public class ThirdMonthDisciplinaryStatus extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("USERAUTH") != null) {
			...
			Status = FacultyDao.assignThirdMonthDisciplinaryReport(DatabaseIds, StudentStatus, StudentRating);
			if(Status == true)

...
/**
 * Servlet implementation class ThirdMonthAttendance
 */
@WebServlet("/ThirdMonthAttendance")
public class ThirdMonthAttendance extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("USERAUTH") != null) {
			...
			Status = FacultyDao.thirdMonthAttendanceSubmission(DatabaseIds, StudentAttendance, totalClasses);
			if(Status == true)

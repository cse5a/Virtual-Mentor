...
/**
 * Servlet implementation class InitiationMarkAssign
 */
@WebServlet("/InitiationMarkAssign")
public class InitiationMarkAssign extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InitiationMarkAssign() {
        super();

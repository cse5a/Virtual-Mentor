...
/**
 * Servlet implementation class SemesterMark
 */
@WebServlet("/SemesterMark")
public class SemesterMark extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("USERAUTH") != null) {
			...
			int count=0,size,SemesterFullMark;
			...
			SemesterFullMark = Integer.parseInt(request.getParameter("fullMark"));
			...
			Status = FacultyDao.semesterMarkAssign(DatabaseIds, StudentMarks, SemesterFullMark);
			if(Status == true)
